...
2. Uses `copilot` CLI to inspect the project changes and generate a commit message suggestion
...
7. Creates a pull request with `gh pr create`
...
- `github-web-style-commit-pr-0.0.2.vsix`

To install it:

1. Open VS Code
2. Run `Extensions: Install from VSIX...`
3. Choose `github-web-style-commit-pr-0.0.2.vsix`
